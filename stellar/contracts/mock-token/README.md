...
The choice is dictated by how the manager calls the token in burning mode:

- Burning **outbound** calls `burn(from, amount)`, authorized by the holder. A stock Stellar Asset Contract supports this.
